...
<div class="max-w-4xl mx-auto">
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
            <div>
                <h1 class="text-xl sm:text-2xl font-bold text-gray-900">Create Position</h1>
                <p class="mt-1 text-sm text-gray-500">Add a new position to the organization</p>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <form action="{{ route('positions.store') }}" method="POST" class="p-4 sm:p-6 space-y-6">
                @csrf
