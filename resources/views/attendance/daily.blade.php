@extends('layouts.dashboard-base', ['user' => $user, 'activeRoute' => 'attendance.daily'])
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
        <form method="GET" action="{{ route('attendance.daily') }}" class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
            <div class="flex-1">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-lg font-semibold text-gray-900">{{ $summary['present'] }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-lg font-semibold text-gray-900">{{ $summary['absent'] }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-lg font-semibold text-gray-900">{{ $summary['late'] }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-lg font-semibold text-gray-900">{{ $summary['attendance_rate'] }}%</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <div class="px-4 sm:px-6 py-4 border-b border-gray-200">
            ...
            <p class="mt-1 text-sm text-gray-600">Daily attendance for {{ $date->format('F d, Y') }}</p>
        </div>
