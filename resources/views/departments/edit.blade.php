...
<div class="max-w-2xl mx-auto">
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Edit Department</h1>
                <p class="mt-1 text-sm text-gray-600">Update department information</p>
            </div>
            ...
            <form method="POST" action="{{ route('departments.update', $department) }}" class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="budget" id="budget" value="{{ old('budget', $department->budget) }}" min="0" step="0.01"
