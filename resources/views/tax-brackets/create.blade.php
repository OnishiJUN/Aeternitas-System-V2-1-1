...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Create Tax Bracket</h1>
            <p class="mt-1 text-sm text-gray-500">Add a new tax bracket for payroll calculations</p>
        </div>
    ...
    <div class="max-w-4xl">
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <form method="POST" action="{{ route('tax-brackets.store') }}" class="p-6 space-y-6">
                @csrf
                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="description" id="description" rows="3" 
                                          ...
                                          placeholder="Optional description for this tax bracket">{{ old('description') }}</textarea>
                                @error('description')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
