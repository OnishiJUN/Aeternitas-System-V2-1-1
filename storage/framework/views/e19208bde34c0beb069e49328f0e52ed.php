    ...
    <div class="relative z-10 w-full max-w-md">
        ...
        <div class="bg-white/95 backdrop-blur-xl border border-blue-200/20 rounded-2xl p-8 shadow-2xl">
            ...
            <?php if($errors->any()): ?>
                <div class="mb-4 p-4 bg-red-50 border border-red-200 rounded-lg text-red-800 text-sm">
                    <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <p><i class="fas fa-exclamation-circle mr-2"></i><?php echo e($error); ?></p>
            ...
            <form method="POST" action="<?php echo e(route('password.email')); ?>" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input 
                            ...
                            class="w-full px-4 py-3 pl-12 bg-white border border-blue-300 rounded-lg text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 <?php echo e($errors->has('email') ? 'border-red-500' : ''); ?>"
                ...
                <div class="text-center">
                    <a href="<?php echo e(route('login')); ?>" class="text-sm text-blue-600 hover:text-blue-700 transition-colors inline-flex items-center">
        ...
        <div class="text-center mt-8">
            <p class="text-blue-100 text-sm">
                ...
                <a href="<?php echo e(route('login')); ?>" class="text-white font-semibold hover:underline">Sign In</a>
            </p>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\internship\Aeternitas-System-V2\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>