                                    ...
                                    <td class="calendar-day px-3 py-4 text-center border-l border-gray-200 hover:bg-gray-50 transition-colors" data-date="<?php echo e($day['date']->format('Y-m-d')); ?>">
                                        ...
                                        <?php else: ?>
                                            <div class="text-gray-400 text-xs">
                                                <a href="<?php echo e(route('schedule-v2.create', array_merge(['employee_id' => $employee->id, 'date' => $day['date']->format('Y-m-d')], array_filter(['department_id' => $selectedDepartment, 'month' => $selectedMonth, 'year' => $selectedYear, 'search' => $searchQuery])))); ?>" class="hover:text-blue-600">
...
<?php echo $__env->make('layouts.dashboard-base', ['user' => $user, 'activeRoute' => 'attendance.timekeeping'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\internship\Aeternitas-System-V2\resources\views/attendance/schedule-v2/index.blade.php ENDPATH**/ ?>