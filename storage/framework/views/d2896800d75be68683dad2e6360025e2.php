<?php $__env->startSection('title', 'New Leave Request'); ?>
...
<div class="max-w-4xl mx-auto">
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
            ...
            <a href="<?php echo e(route('attendance.leave-management')); ?>" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-lg font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
        ...
        <div id="leaveBalanceContainer" class="bg-blue-50 border border-blue-200 rounded-lg p-4 <?php echo e(($employee && $leaveBalance) ? '' : 'hidden'); ?>">
            <h3 class="text-sm font-medium text-blue-900 mb-3" id="balanceTitle"><?php echo e(in_array($user->role, ['admin', 'hr']) ? 'Employee Leave Balance' : 'Your Leave Balance'); ?></h3>
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3" id="balanceGrid">
                <?php if($employee && $leaveBalance): ?>
                <div>
                    <div class="text-xs text-blue-700">Vacation</div>
                    <div class="text-sm font-semibold text-blue-900" id="balance-vacation"><?php echo e($availableDays['vacation'] ?? 0); ?> days</div>
                </div>
                <div>
                    <div class="text-xs text-blue-700">Sick</div>
                    <div class="text-sm font-semibold text-blue-900" id="balance-sick"><?php echo e($availableDays['sick'] ?? 0); ?> days</div>
                </div>
                <div>
                    <div class="text-xs text-blue-700">Personal</div>
                    <div class="text-sm font-semibold text-blue-900" id="balance-personal"><?php echo e($availableDays['personal'] ?? 0); ?> days</div>
                </div>
                <div>
                    <div class="text-xs text-blue-700">Emergency</div>
                    <div class="text-sm font-semibold text-blue-900" id="balance-emergency"><?php echo e($availableDays['emergency'] ?? 0); ?> days</div>
                </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div id="leave-request-data" 
                 data-available-days='<?php echo json_encode($availableDays ?? []); ?>' 
                 data-should-check-balance='<?php echo json_encode($employee && $leaveBalance ? true : false); ?>'
                 style="display: none;"></div>
            <form method="POST" action="<?php echo e(route('attendance.leave-management.store')); ?>" class="p-4 sm:p-6 space-y-6" id="leaveRequestForm">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                        <div class="sm:col-span-2">
                            ...
                            <select name="employee_id" id="employee_id" required
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-transparent <?php $__errorArgs = ['employee_id'];
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                        <div>
                            ...
                            <select name="leave_type" id="leave_type" required
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-transparent <?php $__errorArgs = ['leave_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <option value="bereavement" <?php echo e(old('leave_type') == 'bereavement' ? 'selected' : ''); ?>>Bereavement Leave</option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" name="days_requested" id="days_requested" min="1" readonly
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-50 text-gray-700 cursor-not-allowed <?php $__errorArgs = ['days_requested'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__errorArgs = ['days_requested'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="start_date" id="start_date" value="<?php echo e(old('start_date')); ?>" required
                                placeholder="Select start date"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-transparent <?php $__errorArgs = ['start_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="end_date" id="end_date" value="<?php echo e(old('end_date')); ?>" required
                                placeholder="Select end date"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-transparent <?php $__errorArgs = ['end_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea name="reason" id="reason" rows="4" required
                                ...
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-transparent <?php $__errorArgs = ['reason'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex justify-end space-x-3 pt-6 border-t border-gray-200">
                    <a href="<?php echo e(route('attendance.leave-management')); ?>" class="px-4 py-2 border border-gray-300 rounded-lg font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
                        Cancel
                    </a>
    ...
    if (employeeSelect) {
        employeeSelect.addEventListener('change', function() {
            ...
            if (employeeId) {
                ...
                fetch('<?php echo e(route("attendance.leave-management.balance")); ?>?employee_id=' + employeeId + '&year=' + new Date().getFullYear())
...
<?php echo $__env->make('layouts.dashboard-base', ['user' => $user, 'activeRoute' => 'attendance.leave-management'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\internship\Aeternitas-System-V2\resources\views/attendance/leave-request-create.blade.php ENDPATH**/ ?>