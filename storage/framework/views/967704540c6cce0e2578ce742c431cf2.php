            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="date" id="tax_date" name="tax_date" value="<?php echo e(date('Y-m-d')); ?>"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $taxBrackets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bracket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($bracket->name); ?></div>
                                    <?php if($bracket->description): ?>
                                        <div class="text-xs text-gray-500 mt-1"><?php echo e($bracket->description); ?></div>
                                    <?php endif; ?>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">
                                        ₱<?php echo e(number_format($bracket->min_income, 2)); ?>

                                        <?php if($bracket->max_income): ?>
                                            - ₱<?php echo e(number_format($bracket->max_income, 2)); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($bracket->tax_rate == 0 ? 'bg-green-100 text-green-800' : 'bg-blue-100 text-blue-800'); ?>">
                                        <?php echo e($bracket->tax_rate); ?>%
                                    </span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    ₱<?php echo e(number_format($bracket->base_tax, 2)); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    ₱<?php echo e(number_format($bracket->excess_over, 2)); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($bracket->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                        <?php echo e($bracket->is_active ? 'Active' : 'Inactive'); ?>

                                    </span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        <a href="<?php echo e(route('tax-brackets.show', $bracket)); ?>" class="text-blue-600 hover:text-blue-900 transition-colors" title="View">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="<?php echo e(route('tax-brackets.edit', $bracket)); ?>" class="text-indigo-600 hover:text-indigo-900 transition-colors" title="Edit">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <button type="button" onclick="openDeleteModal('<?php echo e($bracket->id); ?>', '<?php echo e($bracket->name); ?>')" class="text-red-600 hover:text-red-900 transition-colors" title="Delete">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    calculateBtn.addEventListener('click', function() {
        ...
        // Make AJAX request
        fetch('<?php echo e(route("tax-brackets.calculate")); ?>', {
            method: 'POST',
            headers: {
