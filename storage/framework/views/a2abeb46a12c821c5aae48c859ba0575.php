...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="mt-4 sm:mt-0">
            <a href="<?php echo e(route('departments.create')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-lg font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow department-card flex flex-col" 
             data-name="<?php echo e(strtolower($department->name)); ?>"
             data-location="<?php echo e($department->location); ?>">
            <!-- Department Header -->
            <div class="p-6 border-b border-gray-200">
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        <h3 class="text-lg font-semibold text-gray-900 mb-1"><?php echo e($department->name); ?></h3>
                        <p class="text-sm text-gray-500"><?php echo e($department->department_id); ?></p>
                    </div>
                    <div class="flex items-center space-x-2">
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                            <i class="fas fa-users mr-1"></i>
                            <?php echo e($department->employees_count); ?> <?php echo e(\Illuminate\Support\Str::plural('employee', $department->employees_count)); ?>
            ...
            <div class="p-6 space-y-4 flex-1">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600"><?php echo e($department->description ?: 'No description provided'); ?></p>
                </div>
                ...
                <div>
                    ...
                    <p class="text-lg font-semibold text-gray-900">₱<?php echo e(number_format($department->budget, 2)); ?></p>
                </div>
            </div>
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 mt-auto">
                <div class="flex items-center justify-between">
                    <div class="flex space-x-2">
                        <a href="<?php echo e(route('departments.show', $department)); ?>" class="inline-flex items-center px-3 py-1.5 text-xs font-medium text-blue-600 hover:text-blue-900 transition-colors">
                            <i class="fas fa-eye mr-1"></i>View
                        </a>
                        <a href="<?php echo e(route('departments.edit', $department)); ?>" class="inline-flex items-center px-3 py-1.5 text-xs font-medium text-indigo-600 hover:text-indigo-900 transition-colors">
                            <i class="fas fa-edit mr-1"></i>Edit
                        </a>
                        <a href="<?php echo e(route('departments.employees', $department)); ?>" class="inline-flex items-center px-3 py-1.5 text-xs font-medium text-green-600 hover:text-green-900 transition-colors">
                            <i class="fas fa-users mr-1"></i>Employees
                        </a>
                    </div>
                    <button type="button" onclick="openDeleteModal('<?php echo e($department->id); ?>', '<?php echo e($department->name); ?>')" class="inline-flex items-center px-3 py-1.5 text-xs font-medium text-red-600 hover:text-red-900 transition-colors">
...
<?php echo $__env->make('layouts.dashboard-base', ['user' => $user, 'activeRoute' => 'departments.index'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\internship\Aeternitas-System-V2\resources\views/departments/index.blade.php ENDPATH**/ ?>